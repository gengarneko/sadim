 ...
 * @returns A boolean indicating if the provided component is a tag.
 */
export function isTagComponent(item: any): item is TagComponentType {
 ...
 */
export function createEntity(entities: Entities, id: number) {
 ...
 */
export function createEntities(world: World) {
...
export function createSystem(world: World) {
  return world.spawn();
}
