...
export class Query {
   ...
   */
  public onEntityAdded: Signal<(snapshot: EntitySnapshot) => void> =
    new Signal();
  /**
   * Signal dispatches if entity stops matching query
   */
  public onEntityRemoved: Signal<(snapshot: EntitySnapshot) => void> =
    new Signal();
   ...
   * @internal
   */
  public entityComponentAdded = <T>(
    entity: Entity,
    componentOrTag: NonNullable<T>,
   ...
   * @internal
   */
  public entityComponentRemoved = <T>(
    entity: Entity,
...
export class QueryBuilder {
   ...
   */
  public build(): Query {
    return new Query((entity: Entity) =>
      hasAll(entity, this._components, this._tags),
    );
  }
